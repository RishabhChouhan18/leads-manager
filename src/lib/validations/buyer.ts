...
export const buyerSchema = baseBuyerSchema.refine((data) => {
  // If propertyType is Apartment or Villa, bhk is required
  ...
  // Budget max should be greater than min if both are provided
...
// Update schema using the base schema without refinements
...
export type BuyerFormData = z.infer<typeof buyerSchema>;
export type BuyerSearchData = z.infer<typeof buyerSearchSchema>;